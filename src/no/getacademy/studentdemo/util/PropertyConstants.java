package no.getacademy.studentdemo.util;
...
public class PropertyConstants 
{
    ...
    public final static String TEACHERIDPROPERTY_NAME = "teacherId";   
    public final static String TEACHERNAMEPROPERTY_NAME = "teacherName";   
